...
public class Magpie3
{
    ...
    int startPos)
    {
        ...
        while(index > -1)
        {
            ...
            // if(index == 0 || statement.substring(lastIndex, lastIndex+1).equals(" ");
            // if(num != 0 && 100/num < 1)

            //test if letter prior to goal is space 
            if(front == true && back == true)
            //&& tests two things only in boolean-- means AND 
            // "||" is equal to OR 
            //or if(front && back== true)
